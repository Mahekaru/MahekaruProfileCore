...
namespace MahekaruProfileCore.Controllers
{
    ...
    public class APIProfileController : ControllerBase
    {
        ...
        public APIProfileController(MahekaruProfileCoreAPIContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Profiles
        [HttpGet]
        public async Task<ActionResult<IEnumerable<APIProfileModel>>> GetProfile()
        {
        ...
        //GET: api/Profiles/5
        [HttpGet("{id}")]
        public async Task<ActionResult<APIProfileModel>> GetProfile(int id)
        {
